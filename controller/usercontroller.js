...
const register =async(req,res)=>{
    ...
    let {Mobilenumber,Fullname,Email,ReferralCode}=req.body;
        const myreferalCode=generateReferralCode();//call function
        const user= await userservice.registeruser(Mobilenumber,Fullname,Email,ReferralCode,myreferalCode)// adding my refferal code..
        res.json(user)
    }
...
{
   return userservice.generate(5);  //call generate function and get code 
